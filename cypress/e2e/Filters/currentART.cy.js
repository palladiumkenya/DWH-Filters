describe("DWHCT", function () {
    ...
    it("Select NAIROBI county and validate its attribute", function () {
      cy.visit("https://dwh.nascop.org/#/hiv-treatment/currentOnArt");
    ...
    it("Select Melchezedek Hospital facility and validate its attribute", function () {
        ...
        //cy.get('.visible > :nth-child(5) > .text').click({
         ...
         // multiple:true
        //});
         cy.xpath('//*[@id="facility"]/div[2]/div[4]/span').click({
         force: true,
         multiple: true,
         });
    
    
        cy.xpath('//*[@id="facility"]/a').should('include.text','Melchezedek Hospital' );
