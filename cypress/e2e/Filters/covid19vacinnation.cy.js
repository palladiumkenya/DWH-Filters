describe("DWHCT", function () {
    ...
    it("Select NAIROBI county and validate its attribute", function () {
      cy.visit("https://dwh.nascop.org/#/hiv-treatment/covid/vaccination");
    ...
    it("Select CIHEB CONNECT Service Delivery Partner and validate its attribute", function () {
   ...
   // });
    ...
    it("Select Female sex and validate its attribute", function () {
    ...
    it("Select 20-24 age and validate its attribute", function () {
